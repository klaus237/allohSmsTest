describe('Login', ()=> {
    ...
    beforeEach(()=>{
     ...
     function showToastMessage(){
         cy.get('#toast-container').contains('Entrée invalide ou incomplete').should('be.visible')
    }
 
    it('it should display an error message when username and password are empty ',()=>{
    ...
    it('it should display error message when username field is empty ',()=>{
    ...
    it('it should display error message when password field is empty ',()=>{
      ...
      it('it should display error message when username and password are wrong ',()=>{
     ...
     it('it should display error message when username is wrong ',()=>{
     ...
     it('it should display error message when password is wrong ',()=>{
     ...
     it('it should display success message when credentials are good ',()=>{
        
         cy.login('237695859504', '0101abc')
     ...
     it('it should display success message when login with username not with user number othervise ask user to enter number not username ',()=>{
  ...
  it('it should display success message when login with valid number without 237 ',()=>{
    //here valid login number is 237667646589
